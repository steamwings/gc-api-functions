...
{
    [TestClass]
    public class ProfilePicUrlTests
    {
        ...
        public void TestInit()
        {
            ...
            _container = TestHelper.CreateStorageContainer(TestContext, StorageContainer.ProfilePicsUploads);
        ...
        {
            typeof(ProfilePicUrlTests).GetMethod(functionName, BindingFlags.Instance | BindingFlags.NonPublic)
